...
export default {
	onLaunch: function() {
		...
		if (config && config.color !== '') {
			...
			fristColor.tabList = ["/static/images/tabBar/tab-home-green.png", "/static/images/tabBar/tab-cate-green.png", "/static/images/tabBar/tab-cart-green.png", "/static/images/tabBar/tab-user-green.png"];
			uni.setTabBarStyle({
				selectedColor: '#39b54a'
			});
			for (var i = 0; i < fristColor.tabList; i++) {
				let img = fristColor.tabList[i];
				uni.setTabBarItem({
					//设置tabBar 首页图标
					index: i,
					selectedIconPath: img
