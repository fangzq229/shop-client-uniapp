<template>
	<view>
		<view class="order">
			...
			<!-- 商品详情 -->
			<view v-for="(item, index) in orderDetails.orderProduct" :key="index" class="goods">
			...
			<!-- <view class="order_ewm">
				...
				<view class="center_ewm"><image src="/static/images/ewm.png"></image></view>
			</view> -->
			<!-- 订单详情 -->
			<view class="order_more">
				<view class="morelist">
					<text class="title">商品总价</text>
					<view class="right_title">￥{{ orderDetails.totalPrice }}</view>
				</view>
				<view class="morelist">
					<view class="title">
				...
				<view class="morelist">
					...
					<view class="right_title" :style="'color:' + colors + ';'">￥{{ orderDetails.payPrice }}</view>
				</view>
				<view class="morelist">
				...
				<view class="morelist">
					...
					<view class="right_title">{{ orderDetails.createdAt }}</view>
				</view>
				<!-- <view class="tips">
					<view class="tips_name">备注信息</view>
					<view class="textarea_box">
						<textarea placeholder="请输入备注信息" disabled="true" placeholder-class="font-size: 24upx" maxlength="-1" v-model="orderDetails.tips"></textarea>
					</view>
				</view> -->
			</view>
			<view class="bottom_btn">
				<block v-if="orderDetails.payStatus == 10 && orderDetails.status == 10">
					<view class="moneys">
						合计:
