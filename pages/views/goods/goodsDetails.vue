<template>
	<view class="goodsDetails">
		...
		<view :class="'previewvideo ' + (showVideo == true ? 'onshowvideo' : '')">
			...
			<view class="videos">
				<video class="nowvideos" id="nowVideo" :src="goodsData.videos" :autoplay="showVideo" show-center-play-btn="false" show-mute-btn="true" :show-fullscreen-btn="true"></video>
			</view>
		</view>
		<!-- 返回顶部按钮 -->
